...
export const dataFooter = [
	...
	},
	{
		...
		title: 'Оплата',
		text: 'Принимаем наличный и безналичный расчёт. Для безналичного расчёта звоните по телефону +375 29 000-00-00. Расчёт по банковским картам временно не осуществляем, за что дико извиняемся, мы работаем над этим вопросом.',
		add: '',
	},
	{
		id: 3,
